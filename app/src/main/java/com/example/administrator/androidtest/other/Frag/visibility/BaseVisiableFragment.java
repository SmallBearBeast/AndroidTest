...
public abstract class BaseVisiableFragment extends ComponentFragment {
            ...
            if (isVisibleToUser) {
                ...
                if (childFragmentList != null && childFragmentList.size() > 0) {
                    for (Fragment childFragment : childFragmentList) {
                        if (childFragment instanceof BaseVisiableFragment) {
                            BaseVisiableFragment childBaseFragment = (BaseVisiableFragment) childFragment;
