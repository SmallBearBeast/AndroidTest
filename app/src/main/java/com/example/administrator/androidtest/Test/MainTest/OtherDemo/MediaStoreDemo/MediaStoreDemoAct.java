...
import com.example.administrator.androidtest.Common.Media.Provider.MediaStoreHelper;
...
public class MediaStoreDemoAct extends ComponentAct {
...
//        provider.getApk();
    ...
    public static void start(Context context) {
        context.startActivity(new Intent(context, MediaStoreDemoAct.class));
    }
}
