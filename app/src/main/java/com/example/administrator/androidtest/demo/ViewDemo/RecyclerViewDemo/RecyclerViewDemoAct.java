...
public class RecyclerViewDemoAct extends ComponentAct implements View.OnClickListener {
...
//        });
    ...
    public static void start(Context context) {
        context.startActivity(new Intent(context, RecyclerViewDemoAct.class));
    }
}
