...
class OkRequestProvider {
     ...
     * get请求
     */
    Request requestGet(String url, Map<String, String> params, Headers headers) {
     ...
     * post请求
     */
    Request requestPost(String url, Map<String, String> params, Headers headers){
     ...
     */
    Request requestJsonPost(String url, Object jsonObj, Headers headers){
        return requestJsonPost(url, InternalUtil.toJson(jsonObj), headers);
    }

    Request requestJsonPost(String url, String json, Headers headers){
     ...
     * multipart的post
     */
    Request requestMultipartPost(String url, Headers headers, Map<String, String> params, final OkUploadCallback UPLOAD_CALLBACK, final File... FILES){
