...
import com.bear.libcommon.util.BitmapUtil;
...
import com.bear.libfresco.Listener.DispatchControllListener;
import com.bear.libfresco.Listener.DispatchImageOriginListener;
import com.bear.libfresco.Listener.DispatchRequestListener;
import com.bear.libfresco.Listener.LogControllListener;
import com.bear.libfresco.Listener.LogImageOriginListener;
import com.bear.libfresco.Listener.LogRequestListener;
        ...
        if(!FileUtil.isFileExist(PATH)){
            ...
            DATASOURCE.subscribe(new BaseBitmapDataSubscriber() {
                ...
                protected void onNewResultImpl(final Bitmap BITMAP) {
                    ...
                    if(MainHandlerUtil.isMainThread()){
                        ExecutorUtil.execute(run);
                    }else {
                        run.run();
                    }
                    DATASOURCE.close();
